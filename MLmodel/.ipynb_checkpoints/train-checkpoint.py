...
model = joblib.load("YoutubeBotDetector/MLmodel/kn-model.joblib")
model.fit(X_train_scaled, y_train)

print(f"KNeighbors: {model.score(X_test_scaled, y_test)}")

joblib.dump(model, "YoutubeBotDetector/MLmodel/kn-model.joblib")
pass